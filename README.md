...
<table>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <b>React, FastAPI, OpenAI, ElevenLabs, AWS S3, MermaidJS</b> – Automated GitHub repository analysis with AI-generated architecture diagrams and podcast narrations.
    ...
    <td width="50%" valign="top">
      ...
      <b>React, FastAPI, Groq LLM, Supabase, ChromaDB</b> – Intelligent hiring platform with vector-based resume matching and AI-powered candidate screening.
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <b>React, Three.js, Tailwind CSS, FastAPI, OpenAI</b> – Immersive 3D portfolio experience with WebGL rendering and interactive AI-powered features.
    ...
    <td width="50%" valign="top">
      ...
      <b>Next.js, MongoDB, Qwen3 LLM</b> – Dynamic quiz generation platform using advanced LLM models for personalized learning experiences.
